class TreeDisplayController < ApplicationController
  ...
  around :methods => [:goto_questionnaires, :goto_review_rubrics, :goto_metareview_rubrics, :goto_teammatereview_rubrics, :goto_author_feedbacks, :goto_global_survey, :goto_surveys, :goto_course_evaluations, :goto_courses, :goto_assignments, :list, :drill] do |join_point, object, *args|
