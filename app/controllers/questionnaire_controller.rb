class QuestionnaireController < ApplicationController
  ...
  around :methods => [:copy, :delete, :view, :edit, :new, :create_questionnaire, :edit_advice, :save_advice, :save_questionnaire, :save_new_questions, :delete_questions ] do |join_point, object, *args|
